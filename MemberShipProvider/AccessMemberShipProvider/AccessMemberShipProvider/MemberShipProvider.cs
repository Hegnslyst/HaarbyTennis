...
/// <summary>
/// Summary description for AccesMemberShipProvider
/// </summary>
/*
...
namespace HaarbyTennis.Provider
{
    ...
    // 
            ...
            cmd.Parameters.Add("@PasswordQuestion", OdbcType.VarChar, 255).Value = string.Empty; // passwordQuestion; 
            cmd.Parameters.Add("@PasswordAnswer", OdbcType.VarChar, 255).Value = string.Empty; // EncodePassword(passwordAnswer); 

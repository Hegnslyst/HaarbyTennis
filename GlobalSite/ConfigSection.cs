...
{
    #region HaarbyTennisSection
    public class HaarbyTennisSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("public", IsRequired = true)]
        public PublicElement Public
        {
            get { return (PublicElement)base["public"]; }
        }
        [ConfigurationProperty("medlem", IsRequired = true)]
        public MedlemElement Medlem
        {
            get { return (MedlemElement)base["medlem"]; }
        }
    }
    #endregion

    #region ContactFormElement
    ...
    #region PublicElement
    public class PublicElement : ConfigurationElement
    {
        [ConfigurationProperty("connectionStringName")]
        public string ConnectionStringName
        {
        ...
        [ConfigurationProperty("providerType", DefaultValue = "HaarbyTennis.DAL.SqlClient.AccessNyhedProvider")]
        public string ProviderType
        {
            get { return (string)base["providerType"]; }
            set { base["providerType"] = value; }
    ...
    #region MedlemElement
    public class MedlemElement : ConfigurationElement
    {
        [ConfigurationProperty("connectionStringName")]
        public string ConnectionStringName
        {
        ...
        //[ConfigurationProperty("providerType", DefaultValue = "MB.TheBeerHouse.DAL.SqlClient.SqlStoreProvider")]
        [ConfigurationProperty("providerType", DefaultValue = "HaarbyTennis.DAL.SqlClient.AccessMedlemProvider")]
        public string ProviderType
        {
            get { return (string)base["providerType"]; }
            set { base["providerType"] = value; }
